  ...
  sendSubscriptionConfirmation: (req, res) => {
    ...
    const message = {
      ...
      html: `
          ...
          <p>Ваш промокод на первое бронирование:</p>
          <h3>TIGERS2024</h3>
          <p>Мы рады, что вам интересна тема путешествий — теперь мы сможем делиться с вами самыми актуальными новинками.</p>
          <p>До встречи на Wild Tours!</p>
        `,
